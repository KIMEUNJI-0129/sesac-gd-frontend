...
// 같은 기능을 재사용 하는 경우에 이렇게 함수를 선언하고, addEventListener에서 불러와 사용함
// addEventListener에 함수를 불러올 때 괄호 작성 x
// 괄호 작성 시 js를 파싱하면서 해당 코드와 만나면 바로 해당 함수를 실행시킴
// click 이벤트가 발생했을 때, 실행되어야 하기 때문에 괄호없이 작성하는 것.
